...
const templates = {
  welcome: (name) => ({
    subject: 'Welcome to Sportscar Rent!',
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        <h2>Welcome to Rev X Rent!</h2>
        <p>Thank you for joining Sportscar Rent. We're excited to have you on board!</p>
        <p>You can now start renting and exploring our wide range of vehicles.</p>
        <p>Best regards,<br>The Sportscar Rent Team</p>
      </div>
    `
  }),
  ...
  orderConfirmation: (order) => ({
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <p>Order Details:</p>
        ${orderDetails}
        <p>Thank you for choosing Sportscar Rent!</p>
        <p>Best regards,<br>The Sportscar Rent Team</p>
      </div>
    `
  }),
