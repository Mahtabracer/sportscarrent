      ...
      <section className="about-section">
        <div className="about-content">
          <div className="about-text">
            <h2>Welcome to Sportscar Rent</h2>
            <p>
              Sportscar Rent is your premier destination for sportscar rentals, offering a wide range of sports vehicles for every journey. We are committed to providing an exceptional rental experience with convenience, reliability, and customer satisfaction at our core.
            </p>
            <p>
