        ...
        <section className="hero-section">
          <div className="hero-content">
            <div className="hero-text">
              ...
              <h1>Welcome to Sportscar Rent</h1>
              <p>Your premium destination for sportscar rentals. Find the perfect ride for your next adventure, business trip, or daily commute.</p>
